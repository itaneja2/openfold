...
class OpenFoldDatasetCustom(torch.utils.data.Dataset):
    """
    """
    def __init__(self,
        datasets: OpenFoldSingleDataset,
    ):
        self.datasets = datasets
...
class OpenFoldMultimerDatasetCustom(torch.utils.data.Dataset):
    ...
    """
    def __init__(self,
        datasets: OpenFoldSingleMultimerDataset,
    ):
        self.datasets = datasets
...
class OpenFoldDataModule(pl.LightningDataModule):
    ...
    def _gen_dataloader(self, stage):
        ...
        if stage == "train":
            ...
            if not(isinstance(dataset,OpenFoldDatasetCustom)) and not(isinstance(dataset,OpenFoldMultimerDatasetCustom)):
                dataset.reroll()
        elif stage == "eval":
