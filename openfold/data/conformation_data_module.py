...
class ConformationVectorFieldSingleDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        seq_embedding = {"s": self._seq_embeddings_dict[curr_unique_id]}
        ...
        rw_conformation_paths_subset = np.random.choice(all_rw_conformation_paths, size=min(self.num_conformations_to_sample, len(all_rw_conformation_paths)), replace=False)
