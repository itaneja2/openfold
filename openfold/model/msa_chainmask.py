...
class MSAAttentionChainMask(nn.Module):
    def __init__(
        self,
        c_in,
        c_hidden,
        ...
        """
        super(MSAAttentionChainMask, self).__init__()
...
class MSARowAttentionWithPairBiasChainMask(MSAAttentionChainMask):
    """
    Implements Algorithm 7.
    """

    def __init__(self, c_m, c_z, c_hidden, no_heads, chain_mask, inf=1e9):
        """
        Args:
            c_m:
                Input channel dimension
        ...
        """
        super(MSARowAttentionWithPairBiasChainMask, self).__init__(
            c_m,
            c_hidden,
            no_heads,
            pair_bias=True,
...
class MSAColumnAttentionChainMask(nn.Module):
    """
    ...
    def __init__(self, c_m, c_hidden, no_heads, chain_mask=None, inf=1e9):
        """
        Args:
            c_m:
            ...
            inf:
                Large number used to construct attention masks
        """
        super(MSAColumnAttentionChainMask, self).__init__()
        ...
        self._msa_att = MSAAttentionChainMask(
            c_in=c_m,
            c_hidden=c_hidden,
            no_heads=no_heads,
            pair_bias=False,
