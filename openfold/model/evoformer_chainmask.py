...
from openfold.model.msa_chainmask import (
    MSARowAttentionWithPairBiasChainMask,
    MSAColumnAttentionChainMask,
    MSAColumnGlobalAttention,
)
from openfold.model.outer_product_mean_chainmask import OuterProductMeanChainMask
from openfold.model.pair_transition import PairTransition
from openfold.model.triangular_attention_chainmask import (
    TriangleAttentionChainMask,
    TriangleAttentionStartingNodeChainMask,
    TriangleAttentionEndingNodeChainMask,
)
from openfold.model.triangular_multiplicative_update_chainmask import (
    TriangleMultiplicationOutgoing,
    TriangleMultiplicationIncoming,
    FusedTriangleMultiplicationIncomingChainMask,
    FusedTriangleMultiplicationOutgoingChainMask
)
...
class PairStackChainMask(nn.Module):
    def __init__(
        self,
        c_z: int,
        c_hidden_mul: int,
        ...
        super(PairStackChainMask, self).__init__()

        if fuse_projection_weights:
            self.tri_mul_out = FusedTriangleMultiplicationOutgoingChainMask(
                c_z,
                c_hidden_mul,
                chain_mask=chain_mask,
            )
            self.tri_mul_in = FusedTriangleMultiplicationIncomingChainMask(
                c_z,
                c_hidden_mul,
                chain_mask=chain_mask,
            )
        ...
        self.tri_att_start = TriangleAttentionChainMask(
            c_z,
            c_hidden_pair_att,
            no_heads_pair,
            chain_mask=chain_mask,
        ...
        self.tri_att_end = TriangleAttentionChainMask(
            c_z,
            c_hidden_pair_att,
            no_heads_pair,
            chain_mask=chain_mask,
...
class MSABlockChainMask(nn.Module, ABC):
    @abstractmethod
    def __init__(self,
        c_m: int,
        c_z: int,
        ...
        opm_first: bool,
        fuse_projection_weights: bool,
        chain_mask_row: torch.Tensor,
        chain_mask_col: torch.Tensor,
        inf: float,
        eps: float,
    ):
        super(MSABlockChainMask, self).__init__()

        self.opm_first = opm_first

        self.msa_att_row = MSARowAttentionWithPairBiasChainMask(
            c_m=c_m,
            c_z=c_z,
            c_hidden=c_hidden_msa_att,
            no_heads=no_heads_msa,
            chain_mask=chain_mask_row,
            inf=inf,
        )
        ...
        self.outer_product_mean = OuterProductMeanChainMask(
            c_m,
            c_z,
            c_hidden_opm,
            chain_mask=chain_mask_row,
        ) #chain_mask_row because input is s,r,c

        self.pair_stack = PairStackChainMask(
            c_z=c_z,
...
class EvoformerBlockChainMask(MSABlockChainMask):
    def __init__(self,
        c_m: int,
        c_z: int,
        c_hidden_msa_att: int,
        ...
        super(EvoformerBlockChainMask, self).__init__(c_m=c_m,
                                             c_z=c_z,
                                             ...
                                             opm_first=opm_first,
                                             fuse_projection_weights=fuse_projection_weights,
                                             chain_mask_row=chain_mask_row,
                                             chain_mask_col=chain_mask_col,
                                             inf=inf,
                                             eps=eps)
        ...
        if not self.no_column_attention:
            self.msa_att_col = MSAColumnAttentionChainMask(
                c_m,
                c_hidden_msa_att,
                no_heads_msa,
                chain_mask=chain_mask_col,
                inf=inf,
            )
...
class ExtraMSABlockChainMask(MSABlockChainMask):
    """ 
        Almost identical to the standard EvoformerBlockChainMask, except in that the
    ...
    def __init__(self,
        ...
        super(ExtraMSABlockChainMask, self).__init__(c_m=c_m,
                                            c_z=c_z,
                                            c_hidden_msa_att=c_hidden_msa_att,
                                            c_hidden_opm=c_hidden_opm,
                                            c_hidden_mul=c_hidden_mul,
...
class EvoformerStackChainMask(nn.Module):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        super(EvoformerStackChainMask, self).__init__()
...
class ExtraMSAStackChainMask(nn.Module):
    """
    ...
    def __init__(self,
        ...
        **kwargs,
        ...
        super(ExtraMSAStackChainMask, self).__init__()
 
        self.ckpt = ckpt
        self.clear_cache_between_blocks = clear_cache_between_blocks
        self.blocks = nn.ModuleList()
        for _ in range(no_blocks):
            block = ExtraMSABlockChainMask(
                c_m=c_m,
                c_z=c_z,
                c_hidden_msa_att=c_hidden_msa_att,
                c_hidden_opm=c_hidden_opm,
